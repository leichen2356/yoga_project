# Logistic Regression training schema

Implemented — notebook 7

![Training schema](3_logistic_regression.svg)
...
flowchart TD
    ...
    N0 --> N1
    N2["3. Train on training split<br/>LogisticRegression: C=1.0, max_iter=3000<br/>class_weight=balanced, seed=42"]
    N1 --> N2
    ...
    N3 --> N4
    N5["6. Save for backend inference<br/>Save scaler + classifier as logistic_regression.joblib<br/>Output: model/code7_subpose_classification/<br/>Save feature order and class mapping in model metadata"]
    N4 --> N5
```
